...
function PartnerSignin(props: PaperProps) {
  ...
  const addAgentFromInviteView = async (token: string) => {
    await axios.post(
      `${process.env.NEXT_PUBLIC_baseURL}/accept-property-invite/`,
      {
...
export const getServerSideProps: GetServerSideProps = async ({
  ...
  try {
    const checkPropertyInvitationCode = async () => {
      await axios.post(
        `${process.env.NEXT_PUBLIC_baseURL}/property-access/check-invitation/`,
        {
    ...
    await checkPropertyInvitationCode();
